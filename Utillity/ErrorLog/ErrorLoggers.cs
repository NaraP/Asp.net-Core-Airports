...
{
    public class ErrorLoggers : IErrorLoggers
    {
        ...
        private void SendMail(string body)
        {
            ...
            objEmailSend.FromMail = ConfigurationManager.AppSettings["FromMail"];
            objEmailSend.ToMail = ConfigurationManager.AppSettings["ToMail"];
            objEmailSend.CCMail = ConfigurationManager.AppSettings["CCMail"];
            objEmailSend.MailSubject = ConfigurationManager.AppSettings["Subject"] + " for user, " + System.Web.HttpContext.Current.Session["EMPNO"] + " in page " + System.Web.HttpContext.Current.Request.ServerVariables["URL"];
